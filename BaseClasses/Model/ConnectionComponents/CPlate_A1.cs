...
{
    public class CConCom_Plate_A1 : CPlate
    {
        float m_fb;
        float m_fh_1;
        float m_fh_2;
        ...
        public CConCom_Plate_A1()
        {
            eConnComponentType = EConnectionComponentType.ePlate;
            BIsDisplayed = true;
        }

        public CConCom_Plate_A1(GraphObj.CPoint controlpoint, float fb_temp, float fh_1_temp, float fh_2_temp, float ft_platethickness, float fPlateRotation, bool bIsDisplayed)
        {
            eConnComponentType = EConnectionComponentType.ePlate;
        ...
        public CConCom_Plate_A1(GraphObj.CPoint controlpoint, float fb_temp, float fh_1_temp, float fh_2_temp, float ft_platethickness, float fSLope_rad_temp, float fPlateRotation, bool bIsDisplayed)
        {
            eConnComponentType = EConnectionComponentType.ePlate;
            BIsDisplayed = bIsDisplayed;
        ...
        {
            PointsOut[0, 0] = 0;
            PointsOut[0, 1] = m_fh_2;

            PointsOut[1, 0] = 0.5f * m_fb;
            PointsOut[1, 1] = m_fh_1;

            PointsOut[2, 0] = 0.5f * m_fb;
            PointsOut[2, 1] = 0;

            PointsOut[3, 0] = -PointsOut[2, 0];
            PointsOut[3, 1] = PointsOut[2, 1];

            PointsOut[4, 0] = -PointsOut[1, 0];
            PointsOut[4, 1] = PointsOut[1, 1];
        }
