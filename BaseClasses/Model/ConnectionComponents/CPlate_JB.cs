...
namespace BaseClasses
{
    public class CConCom_Plate_JB : CPlate
    {
        ...
        void Calc_Coord2D()
        {
            ...
            PointsOut2D[2, 1] = m_fL;

            PointsOut2D[3, 0] = PointsOut2D[1, 0];
            PointsOut2D[3, 1] = PointsOut2D[2, 1] + m_fh_1;

            PointsOut2D[4, 0] = 0.5f * m_fb;
            PointsOut2D[4, 1] = m_fL + m_fh_2;

            PointsOut2D[5, 0] = 0.5f * m_fb;
            PointsOut2D[5, 1] = m_fL + m_fh_2;

            PointsOut2D[6, 0] = 0.5f * m_fb;
            PointsOut2D[6, 1] = m_fL + m_fh_2;

            PointsOut2D[7, 0] = PointsOut2D[0, 0];
            PointsOut2D[7, 1] = PointsOut2D[0, 1];

            PointsOut2D[8, 0] = PointsOut2D[0, 0];
            PointsOut2D[8, 1] = PointsOut2D[0, 1];

            PointsOut2D[9, 0] = PointsOut2D[0, 0];
            PointsOut2D[9, 1] = PointsOut2D[0, 1];

            PointsOut2D[10, 0] = PointsOut2D[0, 0];
            PointsOut2D[10, 1] = PointsOut2D[0, 1];
        }
