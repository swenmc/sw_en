...
namespace BaseClasses
{
    public class CConnectionJoint_J001 : CConnectionJointTypes
    {
        ...
        public CConnectionJoint_J001(CNode Node_temp, CMember FrontColumn_temp, CMember Girt_temp, bool bIsDisplayed_temp)
        {
            ...
            m_arrPlates[0] = new CConCom_Plate_F_or_L(ControlPoint_P1, 0.05f, (float)m_SecondaryMembers[0].CrScStart.h, 0.05f, 0.003f, 0, 0, fRotatePlatesInJointAngle, 0, BIsDisplayed); // Rotation angle in degrees
            m_arrPlates[1] = new CConCom_Plate_F_or_L(ControlPoint_P2, 0.05f, (float)m_SecondaryMembers[0].CrScStart.h, 0.05f, 0.003f, 180, 0, fRotatePlatesInJointAngle, 0, BIsDisplayed); // Rotation angle in degrees
        }
    }
}
