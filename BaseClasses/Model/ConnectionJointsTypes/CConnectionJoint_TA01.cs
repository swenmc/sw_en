...
namespace BaseClasses
{
    public class CConnectionJoint_TA01 : CConnectionJointTypes
    {
        ...
        public CConnectionJoint_TA01(CNode Node_temp, CMember MainFrameColumn_temp, bool bIsDisplayed_temp)
        {
            ...
            m_arrPlates[0] = new CConCom_Plate_BB_BG("BB", ControlPoint_P1, fb_plate, fh_plate, m_flip, m_ft, m_iHoleNo, m_fd_hole, 90, 0, 90, bIsDisplayed_temp); // Rotation angle in degrees
            ...
            if (m_Node.ID != m_MainMember.NodeStart.ID) // If true - joint at start node, if false joint at end node (se we need to rotate joint about z-axis 180 deg)
            {
                ...
                m_arrPlates[0] = new CConCom_Plate_BB_BG("BB", ControlPoint_P1, fb_plate, fh_plate, m_flip, m_ft, m_iHoleNo, m_fd_hole, 90, 0, 180+90, bIsDisplayed_temp); // Rotation angle in degrees
            }
        }
    }
}
