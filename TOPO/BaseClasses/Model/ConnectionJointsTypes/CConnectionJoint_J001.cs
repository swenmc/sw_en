...
namespace BaseClasses
{
    ...
    {
        // Front Girts to Front Wind Post Joint
        public float m_ft;

        public CConnectionJoint_J001() { }

        public CConnectionJoint_J001(CNode Node_temp, CMember FrontColumn_temp, CMember Girt_temp)
        {
            ...
            CScrewArrangement_L screwArrangement = new CScrewArrangement_L(0, referenceScrew, 0.010f, 0.010f, 0.030f, 0.090f, (float)m_SecondaryMembers[0].CrScStart.h, (float)m_SecondaryMembers[0].CrScStart.h, 0f, 0f);
        ...
        {
            return new CConnectionJoint_J001(m_Node, m_MainMember, m_SecondaryMembers[0]);
        }
    }
}
