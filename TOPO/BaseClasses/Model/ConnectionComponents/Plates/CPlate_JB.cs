...
namespace BaseClasses
{
    public class CConCom_Plate_JB : CPlate
    {
        ...
        void Set_DimensionPoints2D()
        {
            ...
            Dimensions[0] = new CDimensionLinear(PointsOut2D[0], PointsOut2D[1], false, true);
            Dimensions[1] = new CDimensionLinear(PointsOut2D[1], PointsOut2D[2], false, true);
            Dimensions[2] = new CDimensionLinear(PointsOut2D[2], PointsOut2D[3], false, true);
