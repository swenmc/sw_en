...
{
    [Serializable]
    public class CConCom_Plate_KFS : CPlate_Frame
    {
        ...
        public CConCom_Plate_KFS(string sName_temp,
        ...
        public override void Calc_Coord2D()
        {
            ...
            PointsOut2D[12].X = Fl_Z;
            PointsOut2D[12].Y = PointsOut2D[9].Y - fy_temp7;

            PointsOut2D[11].X = 0;
            PointsOut2D[11].Y = PointsOut2D[12].Y + (FSlope_rad > 0 ? 0 : fy_temp4);

            PointsOut2D[13].X = 0;
            PointsOut2D[13].Y = PointsOut2D[12].Y;
        }
        ...
        public override void Set_DimensionPoints2D()
        {
            ...
            if (FSlope_rad > 0)
            {
                Dimensions[8] = new CDimensionLinear(plateCenter, PointsOut2D[0], PointsOut2D[13], true, true);
                Dimensions[9] = new CDimensionLinear(plateCenter, PointsOut2D[13], PointsOut2D[10], true, true);
                Dimensions[10] = new CDimensionLinear(plateCenter, PointsOut2D[10], new Point(PointsOut2D[10].X, PointsOut2D[7].Y), true, true);

                Dimensions[11] = new CDimensionLinear(plateCenter, PointsOut2D[3], PointsOut2D[4], false, true);
                Dimensions[12] = new CDimensionLinear(plateCenter, PointsOut2D[4], PointsOut2D[6], false, true);
                Dimensions[13] = new CDimensionLinear(plateCenter, PointsOut2D[6], PointsOut2D[7], false, true);

                Dimensions[14] = new CDimensionLinear(plateCenter, new Point(PointsOut2D[8].X, PointsOut2D[3].Y), PointsOut2D[8], false, true, 63);
                Dimensions[15] = new CDimensionLinear(plateCenter, new Point(PointsOut2D[7].X, PointsOut2D[3].Y), PointsOut2D[7], false, true, 75);

                Dimensions[16] = new CDimensionLinear(plateCenter, PointsOut2D[1], PointsOut2D[9], true, true, 95);
            }
            else
            {
                Dimensions[8] = new CDimensionLinear(plateCenter, PointsOut2D[0], PointsOut2D[13], true, true);
                Dimensions[9] = new CDimensionLinear(plateCenter, PointsOut2D[13], PointsOut2D[11], true, true);
                Dimensions[10] = new CDimensionLinear(plateCenter, PointsOut2D[11], PointsOut2D[10], true, true);
                Dimensions[11] = new CDimensionLinear(plateCenter, PointsOut2D[0], PointsOut2D[10], true, true, 95);

                Dimensions[12] = new CDimensionLinear(plateCenter, PointsOut2D[3], PointsOut2D[4], false, true);
                Dimensions[13] = new CDimensionLinear(plateCenter, PointsOut2D[6], PointsOut2D[7], false, true);
                Dimensions[14] = new CDimensionLinear(plateCenter, new Point(PointsOut2D[8].X, PointsOut2D[3].Y), PointsOut2D[8], false, true, 63);
                Dimensions[15] = new CDimensionLinear(plateCenter, new Point(PointsOut2D[7].X, PointsOut2D[3].Y), PointsOut2D[7], false, true, 75);

                Dimensions[16] = new CDimensionLinear(plateCenter, PointsOut2D[1], PointsOut2D[9], true, true, 80);
            }

            Dimensions[17] = new CDimensionArc(plateCenter, new Point(PointsOut2D[2].X, PointsOut2D[9].Y), PointsOut2D[8], PointsOut2D[9]);
        }
        ...
        public override void Set_BendLinesPoints2D()
        {
            ...
            BendLines[0] = new CLine2D(PointsOut2D[1], PointsOut2D[12]);
        ...
        public override void Set_MemberOutlinePoints2D()
        {
            ...
            MemberOutlines[2] = new CLine2D(new Point(PointsOut2D[12].X, PointsOut2D[12].Y), new Point(PointsOut2D[5].X, PointsOut2D[5].Y));
        }
        ...
        public override void CopyParams(CPlate plate)
        {
            ...
            if (plate is CConCom_Plate_KFS)
            {
                CConCom_Plate_KFS refPlate = (CConCom_Plate_KFS)plate;
