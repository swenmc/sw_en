...
namespace BaseClasses
{
    ...
    public class CConCom_Plate_KK : CPlate_Frame
    {
        ...
        public override void Set_BendLinesPoints2D()
        {
            ...
            BendLines[0] = new CLine2D(PointsOut2D[0], PointsOut2D[5]);
            BendLines[1] = new CLine2D(PointsOut2D[1], PointsOut2D[4]);
            BendLines[2] = new CLine2D(PointsOut2D[6], PointsOut2D[11]);
            BendLines[3] = new CLine2D(PointsOut2D[7], PointsOut2D[10]);
        }
        ...
        public override void CopyParams(CPlate plate)
        {
            ...
            if (plate is CConCom_Plate_KK)
            {
                CConCom_Plate_KK refPlate = (CConCom_Plate_KK)plate;
                this.m_fbXR = refPlate.m_fbXR;
