...
namespace BaseClasses.GraphObj.Objects_3D
{
    ...
    public class Cylinder : CVolume
    {
        ...
        //--------------------------------------------------------------------------------------------
        public static GeometryModel3D CreateM_G_M_3D_Volume_Cylinder(Point3D solidControlEdge, float fDim1_r, float fDim2_L, DiffuseMaterial mat)
        {
            short iTotNoPoints = 73;            
            return CreateM_G_M_3D_Volume_Cylinder(solidControlEdge, iTotNoPoints, fDim1_r, fDim2_L, mat);
        }

        public static GeometryModel3D CreateM_G_M_3D_Volume_Cylinder(Point3D solidControlEdge, short iNumberPoints, float fDim1_r, float fDim2_L, DiffuseMaterial mat)
        {
            short iTotNoPoints = iNumberPoints;
            ...
            {
                if (i < iTotNoPoints - 2)
                    CVolume.AddRectangleIndices_CCW_1234(TriangleIndices, i, iTotNoPoints + i, iTotNoPoints + i + 1, i + 1);
                else
                    CVolume.AddRectangleIndices_CCW_1234(TriangleIndices, i, iTotNoPoints + i, iTotNoPoints, 0); // Last Element
