...
namespace PFD
{
    public static class CComboBoxHelper
    {
        ...
        public static List<CComboColor> ColorList = new List<CComboColor>() {
                ...
                new CComboColor("Black", Colors.Black),
                new CComboColor("BlanchedAlmond", Colors.BlanchedAlmond),
                new CComboColor("Blue", Colors.Blue),
                ...
                new CComboColor("Chartreuse", Colors.Chartreuse),
                ...
                new CComboColor("Crimson", Colors.Crimson),
                ...
                new CComboColor("DarkGreen", Colors.DarkGreen),
                ...
                new CComboColor("DarkOrange", Colors.DarkOrange),
                ...
                new CComboColor("Fuchsia", Colors.Fuchsia),
                new CComboColor("Gainsboro", Colors.Gainsboro),
                ...
                new CComboColor("Green", Colors.Green),
                new CComboColor("GreenYellow", Colors.GreenYellow),
                ...
                new CComboColor("Khaki", Colors.Khaki),
                ...
                new CComboColor("MediumPurple", Colors.MediumPurple),
                ...
                new CComboColor("MediumVioletRed", Colors.MediumVioletRed),
                ...
                new CComboColor("Purple", Colors.Purple),
                new CComboColor("Red", Colors.Red),
                ...
                new CComboColor("Teal", Colors.Teal),
                ...
                new CComboColor("Olive", Colors.Olive),
                new CComboColor("Wheat", Colors.Wheat),
                new CComboColor("White", Colors.White),
                new CComboColor("WhiteSmoke", Colors.WhiteSmoke),
                new CComboColor("Yellow", Colors.Yellow),
                new CComboColor("YellowGreen", Colors.YellowGreen)
        };
