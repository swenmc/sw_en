    ...
    public class SystemComponentViewerViewModel : INotifyPropertyChanged
    {
        ...
        public void SetScrewArrangementProperties(CPlate plate /*CScrewArrangement arrangement*/) // Mala by sem vstupovat cela plate alebo len arrangement ???
        {
            ...
            if (plate.ScrewArrangement != null && plate.ScrewArrangement is CScrewArrangementCircleApexOrKnee)
            {
                ...
                screwArrangmenetProperties.Add(new CComponentParamsViewString(CParamsResources.ScrewGaugeS.Name, CParamsResources.ScrewGaugeS.Symbol, arrangementTemp.referenceScrew.Gauge.ToString(), CParamsResources.ScrewGaugeS.Unit));  // TODO prerobit na vyber objektu skrutky z databazy
