...
namespace PFD
{
    public class CSurfaceLoadGenerator
    {
        ...
        )
        {
            ...
            surfaceWindLoadMinusY_Cpe.Add(new CSLoad_FreeUniformGroup(listOfLoadedMemberTypeDataWallLeftRight, ELoadCoordSystem.eLCS, ELoadDirection.eLD_Z, pWallBackRight, wind.fC_pe_S_wall_dimensions, fWallLeftOrRight_X, fWallLeftOrRight_Y, ELCMainDirection.eMinusY, fp_e_S_wall_Theta_4, fLoadDirectionValueFactor_RightWall, 90, 0, 180 + 90, false, false, true, 0));
