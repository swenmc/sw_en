...
namespace PFD
{
    public static class CModelToBFEMNetConverter
    {
        ...
        public static Model Convert(CModel topomodel, bool bCalculateLoadCasesOnly, bool bConsiderNodalDisplacementOnly = false, bool bConsiderNodalDisplacement = false)
        {
            ...
            topomodel.LoadCombInternalForcesResults = BFEMNetModelHelper.GetResultsList(model, loadcombinations, bConsiderNodalDisplacementOnly, bConsiderNodalDisplacement);
