...
namespace PFD
{
    ...
    public partial class UC_FootingInput : UserControl
    {
        ...
        public UC_FootingInput(/*CPFDViewModel pfdVM*/)
        {
            ...
            vm.ReinforcementGrade = "500B";

            vm.LongReinTop_x_No = 5;
            vm.LongReinTop_x_Phi = 0.012f; // bar diameter mm to m
            vm.LongReinTop_x_distance_s_y = 0.2035f; // m
            vm.LongReinTop_x_distance_s_y = GetDistanceBetweenReinforcementBars(vm.FootingPadSize_y_Or_b, vm.LongReinTop_x_No, vm.LongReinTop_x_Phi, vm.ConcreteCover * 0.001f); // Concrete Cover factor - mm to m (docasne faktor pre konverziu, TODO odstranit a nastavit concrete cover na metre)

            vm.LongReinTop_y_No = 5;
            vm.LongReinTop_y_Phi = 0.012f; // bar diameter mm to m
            vm.LongReinTop_y_distance_s_x = 0.2035f; // m
            vm.LongReinTop_y_distance_s_x = GetDistanceBetweenReinforcementBars(vm.FootingPadSize_x_Or_a, vm.LongReinTop_y_No, vm.LongReinTop_y_Phi, vm.ConcreteCover * 0.001f); // Concrete Cover factor - mm to m (docasne faktor pre konverziu, TODO odstranit a nastavit concrete cover na metre)

            vm.LongReinBottom_x_No = 5;
            vm.LongReinBottom_x_Phi = 0.012f; // bar diameter mm to m
            vm.LongReinBottom_x_distance_s_y = 0.2035f; // m
            vm.LongReinBottom_x_distance_s_y = GetDistanceBetweenReinforcementBars(vm.FootingPadSize_y_Or_b, vm.LongReinBottom_x_No, vm.LongReinBottom_x_Phi, vm.ConcreteCover * 0.001f); // Concrete Cover factor - mm to m (docasne faktor pre konverziu, TODO odstranit a nastavit concrete cover na metre)

            vm.LongReinBottom_y_No = 5;
            vm.LongReinBottom_y_Phi = 0.012f; // bar diameter mm to m
            vm.LongReinBottom_y_distance_s_x = 0.2035f; // m
            vm.LongReinBottom_y_distance_s_x = GetDistanceBetweenReinforcementBars(vm.FootingPadSize_x_Or_a, vm.LongReinBottom_y_No, vm.LongReinBottom_y_Phi, vm.ConcreteCover * 0.001f); // Concrete Cover factor - mm to m (docasne faktor pre konverziu, TODO odstranit a nastavit concrete cover na metre)
