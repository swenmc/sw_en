...
namespace PFD
{
    public class CBlock_3D_002_WindowInBay : CBlock
    {
            ...
            bool bIsLastBayInFrontorBackSide = false)
        {
            ...
            m_arrCrSc = new Dictionary<EMemberType_FS_Position, CCrSc>();// CCrSc[2];
            ...
            m_arrCrSc[(EMemberType_FS_Position)1] = new CCrSc_3_10075_BOX(0, 0.1f, 0.1f, 0.00075f, Colors.Red); // Window frame
            m_arrCrSc[(EMemberType_FS_Position)1].Name_short = "10075";
            m_arrCrSc[(EMemberType_FS_Position)1].m_Mat = m_arrMat[0];
            m_arrCrSc[(EMemberType_FS_Position)1].ID = (int)EMemberType_FS_Position.WindowFrame;
            ...
            float fGirtAlignmentEnd = -0.5f * (float)m_arrCrSc[(EMemberType_FS_Position)1].b - fCutOffOneSide; // Window column
            ...
            {
                float referenceEdgeRafter_alignment_temp = (float)referenceRafter.CrScStart.z_min / (float)Math.Cos(Math.Abs(fRoofPitch_rad)) + (float)m_arrCrSc[(EMemberType_FS_Position)1].y_min * (float)Math.Tan(Math.Abs(fRoofPitch_rad));
                fWindowColumnEnd = referenceEdgeRafter_alignment_temp - fCutOffOneSide;
            }

            float fOffsetBetweenGirtAndColumn_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_max - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_max;
            ...
            float fOffsetBetweenGirtAndHeader_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_max - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_max;
            ...
            float fOffsetBetweenGirtAndSill_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_max - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_max;
            ...
            {
                fOffsetBetweenGirtAndColumn_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_min - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_min;
                ...
                fOffsetBetweenGirtAndHeader_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_min - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_min;
                ...
                fOffsetBetweenGirtAndSill_LCS_z_axis = (float)ReferenceGirt.CrScStart.z_min - (float)m_arrCrSc[(EMemberType_FS_Position)1].z_min;
            ...
            {
                m_arrMembers[iMembersGirts + i] = new CMember(iMembersGirts + i + 1, m_arrNodes[iNodesForGirts + i * 2], m_arrNodes[iNodesForGirts + i * 2 + 1], m_arrCrSc[(EMemberType_FS_Position)1], EMemberType_FS.eWF, EMemberType_FS_Position.WindowFrame, feccentricityWindowColumnStart, feccentricityWindowColumnEnd, fWindowColumnStart, fWindowColumnEnd, fWindowColumnRotation, 0);
            }

            // Window (header)
            // TODO - add to block parameters
            float fWindowHeaderStart = -0.5f * (float)m_arrCrSc[(EMemberType_FS_Position)1].h - fCutOffOneSide;
            float fWindowHeaderEnd = -0.5f * (float)m_arrCrSc[(EMemberType_FS_Position)1].h - fCutOffOneSide;
            ...
            {
                m_arrMembers[iMembersGirts + prop.iNumberOfWindowColumns + i] = new CMember(iMembersGirts + prop.iNumberOfWindowColumns + i + 1, m_arrNodes[iNodesForGirts + iNodesForWindowColumns + i], m_arrNodes[iNodesForGirts + iNodesForWindowColumns + i + 1], m_arrCrSc[(EMemberType_FS_Position)1], EMemberType_FS.eWF, EMemberType_FS_Position.WindowFrame, feccentricityWindowHeaderStart, feccentricityWindowHeaderEnd, fWindowHeaderStart, fWindowHeaderEnd, fWindowHeaderRotation, 0);
            }

            // Window (Sills)
            // TODO - add to block parameters
            float fWindowSillStart = -0.5f * (float)m_arrCrSc[(EMemberType_FS_Position)1].h - fCutOffOneSide;
            float fWindowSillEnd = -0.5f * (float)m_arrCrSc[(EMemberType_FS_Position)1].h - fCutOffOneSide;
            ...
            {
                m_arrMembers[iMembersGirts + prop.iNumberOfWindowColumns + iNumberOfHeaders + i] = new CMember(iMembersGirts + prop.iNumberOfWindowColumns + iNumberOfHeaders + i + 1, m_arrNodes[iNodesForGirts + iNodesForWindowColumns + iNodesForWindowHeaders + i], m_arrNodes[iNodesForGirts + iNodesForWindowColumns + iNodesForWindowHeaders + i + 1], m_arrCrSc[(EMemberType_FS_Position)1], EMemberType_FS.eWF, EMemberType_FS_Position.WindowFrame, feccentricityWindowSillStart, feccentricityWindowSillEnd, fWindowSillStart, fWindowSillEnd, fWindowSillRotation, 0);
            }
