...
namespace PFD
{
    ...
    public class CFootingInputVM : INotifyPropertyChanged
    {
        ...
        private void UpdateSelectedFootingPadsValuesFromGUI()
        {
            ...
            double cp_Top_x_coordX = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover : fConcreteCover + 0.5f * fDiameterTop_Bar_x;
            double cp_Top_x_coordY = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover + 0.5f * fDiameterTop_Bar_x : fConcreteCover + fDiameterTop_Bar_y + 0.5f * fDiameterTop_Bar_x;
            double cp_Top_y_coordX = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover + 0.5f * fDiameterTop_Bar_y : fConcreteCover + fDiameterTop_Bar_x + 0.5f * fDiameterTop_Bar_y;
            double cp_Top_y_coordY = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover : fConcreteCover + 0.5f * fDiameterTop_Bar_y;
            double cp_Bottom_x_coordX = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover : fConcreteCover + 0.5f * fDiameterBottom_Bar_x;
            double cp_Bottom_x_coordY = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover + 0.5f * fDiameterBottom_Bar_x : fConcreteCover + fDiameterBottom_Bar_y + 0.5f * fDiameterBottom_Bar_x;
            double cp_Bottom_y_coordX = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover + 0.5f * fDiameterBottom_Bar_y : fConcreteCover + fDiameterBottom_Bar_x + 0.5f * fDiameterBottom_Bar_y;
            double cp_Bottom_y_coordY = _pfdVM._modelOptionsVM.UseStraightReinforcementBars ? fConcreteCover : fConcreteCover + 0.5f * fDiameterBottom_Bar_y;
            ...
            if (!_pfdVM._modelOptionsVM.UseStraightReinforcementBars)
            {
