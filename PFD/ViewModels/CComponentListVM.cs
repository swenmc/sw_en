    ...
    public class CComponentListVM : INotifyPropertyChanged
    {
        ...
        */
        ...
        public List<string> Colors
        {
            get
            {
                //Mato? tieto komenty su platne? Co nie je platne, tak prosim pomaz!
                ...
                //napojenie na zoznam farieb z CComboBoxHelper
                if (MColors == null) MColors = CComboBoxHelper.ColorList.Select(c => c.Name).ToList();
