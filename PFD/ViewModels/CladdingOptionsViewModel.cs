...
namespace PFD
{
    ...
    public class CladdingOptionsViewModel : INotifyPropertyChanged
    {
        ...
        private void SetFibreglassAreasPercentages()
        {
            ...
            if (MathF.d_equal(_pfdVM.TotalRoofArea, 0)) _pfdVM.CalculateCladdingParameters_Mato();
            if (MathF.d_equal(_pfdVM.TotalWallArea, 0)) _pfdVM.CalculateCladdingParameters_Mato();
