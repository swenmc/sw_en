...
namespace PFD
{
    ...
    public class CModel_PFD_01_GR : CModel_PFD
    {
            ...
            */
            ...
            if (joints == null)
                CreateJoints(bGenerateGirts, bUseMainColumnFlyBracingPlates, bGeneratePurlins, bUseRafterFlyBracingPlates, bGenerateFrontColumns, bGenerateBackColumns, bGenerateFrontGirts,
                             ...
                             bGenerateCanopies, bGeneratePurlinsCanopy, bGeneratePurlinBracingBlocksCanopy, bGenerateCrossBracingCanopy, vm._modelOptionsVM.WindPostUnderRafter, iOneColumnGirtNo);
            else
        ...
        //odpad po refaktoringu _GR a _MR
