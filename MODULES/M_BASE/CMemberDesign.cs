...
namespace M_BASE
{
    public class CMemberDesign
    {
        ...
        // SBD
        public void SetDesignForcesAndMemberDesign_SBD(bool bUseCRSCGeometricalAxes, bool bShearDesignAccording334, bool bIgnoreWebStiffeners, int iNumberOfDesignSections, CMember member, basicInternalForces[,] sBIF_x, designBucklingLengthFactors[] sBucklingLengthFactors, designMomentValuesForCb[] sMomentValuesforCb, out designInternalForces[,] sDIF_x)
        {
            SetDesignForcesAndMemberDesign_SBD(bUseCRSCGeometricalAxes, bShearDesignAccording334, bIgnoreWebStiffeners, 1, iNumberOfDesignSections, member, sBIF_x, sBucklingLengthFactors, sMomentValuesforCb, out sDIF_x);
        }

        public void SetDesignForcesAndMemberDesign_SBD(bool bUseCRSCGeometricalAxes, bool bShearDesignAccording334, bool bIgnoreWebStiffeners, int iNumberOfLoadCombinations, int iNumberOfDesignSections, CMember member, basicInternalForces[,] sBIF_x, designBucklingLengthFactors[] sBucklingLengthFactors, designMomentValuesForCb[] sMomentValuesforCb, out designInternalForces[,] sDIF_x)
        {
            ...
            for (int i = 0; i < iNumberOfLoadCombinations; i++)
            {
                for (int j = 0; j < iNumberOfDesignSections; j++)
                {
                    ...
                    CCalculMember obj_CalcDesign = new CCalculMember(bDebugging, bUseCRSCGeometricalAxes, bShearDesignAccording334, bIgnoreWebStiffeners, sDIF_x[i, j], member, sBucklingLengthFactors[i], sMomentValuesforCb[i]);
        ...
        // PFD
        public void SetDesignForcesAndMemberDesign_PFD(bool bUseCRSCGeometricalAxes, bool bShearDesignAccording334, bool bIgnoreWebStiffeners, int iNumberOfDesignSections, CMember member, basicInternalForces[] sBIF_x,
            designBucklingLengthFactors[] sBucklingLengthFactors, designMomentValuesForCb[] sMomentValuesforCb, out designInternalForces[] sDIF_x)
        {
            ...
            for (int j = 0; j < iNumberOfDesignSections; j++)
            {
                ...
                CCalculMember obj_CalcDesign = new CCalculMember(bDebugging, bUseCRSCGeometricalAxes, bShearDesignAccording334, bIgnoreWebStiffeners, sDIF_x[j], member, sBucklingLengthFactors[j], sMomentValuesforCb[j]);
        ...
        public void SetDesignDeflections_PFD(bool bUseCRSCGeometricalAxes, bool bIsGableRoof, int iNumberOfDesignSections, CMember member, float fDeflectionLimitFraction_Denominator, float fDeflectionLimit, basicDeflections[] sBDeflections_x, out designDeflections[] sDDeflections_x)
        {
            listOfMemberDesignInLocations = new List<CCalculMember>(iNumberOfDesignSections);
            // Design
            ...
            for (int j = 0; j < iNumberOfDesignSections; j++)
            {
                ...
                CCalculMember obj_CalcDesign = new CCalculMember(bDebugging, bUseCRSCGeometricalAxes, bIsGableRoof, sDDeflections_x[j], member, fDeflectionLimitFraction_Denominator, fDeflectionLimit);
