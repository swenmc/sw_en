...
namespace Examples
{
    public class CExample_2D_12 : CExample
    {
        public CExample_2D_12()
        {
            ...
            m_arrCrSc = new System.Collections.Generic.Dictionary<EMemberType_FS_Position, CCrSc>(); // new CCrSc[3];
            ...
            m_arrCrSc[(EMemberType_FS_Position)1] = new CCrSc_0_00();  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            m_arrCrSc[(EMemberType_FS_Position)1].A_g = 1.48571428571E-02f; // Unit [m^2]
            m_arrCrSc[(EMemberType_FS_Position)1].I_y = 1.90476190476E-04f; // Unit [m^4]
            m_arrCrSc[(EMemberType_FS_Position)1].m_Mat = m_arrMat[0]; // Set CrSc Material

            m_arrCrSc[(EMemberType_FS_Position)2] = new CCrSc_0_00();  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            m_arrCrSc[(EMemberType_FS_Position)2].A_g = 1.35238095238E-02f; // Unit [m^2]
            m_arrCrSc[(EMemberType_FS_Position)2].I_y = 1.42857142857E-07f; // Unit [m^4]
            m_arrCrSc[(EMemberType_FS_Position)2].m_Mat = m_arrMat[0]; // Set CrSc Material
            ...
            m_arrMembers[3].CrScStart = m_arrCrSc[(EMemberType_FS_Position)2];
