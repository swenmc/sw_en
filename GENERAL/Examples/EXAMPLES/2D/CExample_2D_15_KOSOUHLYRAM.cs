...
namespace Examples
{
    public class CExample_2D_15_KOSOUHLYRAM : CExample
    {
        public CExample_2D_15_KOSOUHLYRAM()
        {
            ...
            m_arrCrSc[1] = new CCrSc_GE();
            m_arrCrSc[1].A_g = 0.12f;
            m_arrCrSc[1].I_y = 0.0016f;
            ...
            MLoad_n1.EDirPPC = EMLoadDirPCC1.eMLD_PCC_FXX_MXX;
            ...
            MLoad_n2.EDirPPC = EMLoadDirPCC1.eMLD_PCC_FXX_MXX;
            ...
            MLoad_q2.EDirPPC = EMLoadDirPCC1.eMLD_PCC_FZV_MYU;
