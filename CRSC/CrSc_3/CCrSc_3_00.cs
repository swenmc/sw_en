...
namespace CRSC
{
    public class CCrSc_3_00 : CSO
    {
		...
		void CalcCrSc_Coord_I_DS_1() // 1 - Four radii at flanges tips, tapered or parallel flanges (8 auxiliary points)
		{
		    ...
		    for (short i = 0; i < m_iNumOfArcPoints - 1; i++)
		    {
		        CrScPointsOut[iNumberAux + 2 * m_iNumOfArcPoints + i + 10, 0] = CrScPointsOut[0, 0] + Geom2D.GetPositionX_deg(m_fr_2, 90 + i * iRadiusAngle / m_iNumOfArcSegment);      // y
		        CrScPointsOut[iNumberAux + 2 * m_iNumOfArcPoints + i + 10, 1] = CrScPointsOut[0, 1] + Geom2D.GetPositionY_CW_deg(m_fr_2, 90 + i * iRadiusAngle / m_iNumOfArcSegment);    // z
		    }
		}
        ...
        //    // Point No. 1
        //    CrScPointsOutArr[0, 0] = -(float)b / 2f + m_fr_2;    // y
        ...
        //    CrScPointsOutArr[4, 1] = CrScPointsOutArr[3, 1] - m_fr_2 - (((float)h - m_fd - 2 * (m_fr_1 + m_fr_2)) / 2.0f);     // z
        ...
        //    // Point No. 7
        //    CrScPointsOutArr[6, 0] = CrScPointsOutArr[3, 0];      // y
        ...
        //    // Point No. 10
        //    CrScPointsOutArr[9, 0] = CrScPointsOutArr[0, 0];      // y
        ...
        //    // Point No. 13 - 1st Edge point - upper left
        //    CrScPointsOutArr[iNumberAux, 0] = -(float)b / 2.0f;     // y
        //    CrScPointsOutArr[iNumberAux, 1] = (float)h / 2.0f;      // z
        ...
        //    CrScPointsOutArr[4, 1] = -CrScPointsOutArr[3, 1];     // z
        ...
        //    CrScPointsOutArr[6, 1] = -CrScPointsOutArr[1, 1];     // z

        //    // Point No. 8
        //    CrScPointsOutArr[7, 0] = CrScPointsOutArr[0, 0];  // y
        //    CrScPointsOutArr[7, 1] = -CrScPointsOutArr[0, 1];   // z
        ...
        //    CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 1, 1] = CrScPointsOutArr[0, 1] - (((float)h - m_fd - 2 * +m_fr_2) / 2.0f); // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 2, 0] = m_ft_w / 2.0f;         // y
        //    CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 2, 1] = -CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 1, 1];     // z
        ...
        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 8, 0] = -m_ft_w / 2.0f;         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 8, 1] = CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 2, 1];     // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 9, 0] = -m_ft_w / 2.0f;         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 9, 1] = CrScPointsOutArr[iNumberAux + m_iNumOfArcPoints + 1, 1];     // z

        //    // 1st radius - centre "0" (90-180 degrees)
        //    // Do not create last point of segment - it is already defined
        //    for (short i = 0; i < m_iNumOfArcPoints - 1; i++)
        //    {
        //        CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + i + 10, 0] = CrScPointsOutArr[0, 0] + Geom2D.GetPositionX_deg(m_fr_2, 90 + i * iRadiusAngle / m_iNumOfArcSegment);      // y
        //        CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + i + 10, 1] = CrScPointsOutArr[0, 1] + Geom2D.GetPositionY_CW_deg(m_fr_2, 90 + i * iRadiusAngle / m_iNumOfArcSegment);    // z
        //    }
        ...
        //    CrScPointsOutArr[0, 1] = m_fd / 2.0f + m_fr_1;   // z
        ...
        //    // Point No. 5
        //    CrScPointsOutArr[4, 0] = (float)-b / 2.0f;           // y
        //    CrScPointsOutArr[4, 1] = (float)h / 2.0f;           // z
        ...
        //    CrScPointsOutArr[8, 1] = m_fd / 2 + m_fr_1 + (2 * (((float)h - m_fd - 2 * m_fr_1) / 2.0f - m_ft_f));     // z
        ...
        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 5, 0] = CrScPointsOutArr[8, 0];         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 5, 1] = -CrScPointsOutArr[8, 1];        // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 6, 0] = CrScPointsOutArr[7, 0];         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 6, 1] = -CrScPointsOutArr[7, 1];        // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 7, 0] = CrScPointsOutArr[6, 0];         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 7, 1] = -CrScPointsOutArr[6, 1];        // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 8, 0] = CrScPointsOutArr[5, 0];         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 8, 1] = -CrScPointsOutArr[5, 1];        // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 9, 0] = CrScPointsOutArr[4, 0];         // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 9, 1] = -CrScPointsOutArr[4, 1];        // z

        //    // Point No. XX
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 10, 0] = CrScPointsOutArr[4, 0];       // y
        //    CrScPointsOutArr[iNumberAux + 2 * m_iNumOfArcPoints + 10, 1] = -CrScPointsOutArr[8, 1];      // z
