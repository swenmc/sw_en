...
namespace CRSC
{
    public class CCrSc_3_50020_C : CSO
    {
        ...
        public CCrSc_3_50020_C() { }
        public CCrSc_3_50020_C(float fh, float fb, float ft) : this(0, fh, fb, ft, Colors.Red) { }
        public CCrSc_3_50020_C(int iID_temp, float fh, float fb, float ft, Color color_temp)
        {
            ID = iID_temp;

            Name_long = "C " + (fh * 1000).ToString() + (ft * 1000 * 10).ToString(); // Original Description
            Name_long = "C " + (fh * 1000).ToString() + (20).ToString(); // FS system Description
